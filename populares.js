...
const cargarPeliculas = async () => {
    try {
        /*mostramos nuestro font awesome de cargando hasta que tengamos respuesta*/
        ...
        /*con css le he dado estilos para que gire*/
        // se puede hacer que desaparezca el cargando cuando se terminen de renderizar en pantalla pero tendríamos que llevarnos
        // el display none a después de generar las tarjetas y añadirlas con contenedor pertinentes
        // por si la carga es muy rápida se puede simular peor conexión con las herramientas del desarrollador o bien estableciendo
        // un setTimeOut del cargapeliculas cuando se alacance la tarjeta buscada
